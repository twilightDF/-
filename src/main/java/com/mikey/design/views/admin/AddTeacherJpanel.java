        ...
        sunmit.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (checkData(nameJtextField,sexboBox,phoneJtextField)) {
                    ...
                    int result = JOptionPane.showConfirmDialog(showTipMessageLocationJpanel, "确认添加教师？", "系统提示", JOptionPane.YES_NO_CANCEL_OPTION);
                    /**
                     * 提交保存
                     */
                    if (result == JOptionPane.YES_NO_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(showTipMessageLocationJpanel, "添加成功工号为："+teacherByPhone.getTeacherId());
                        reselt.doClick();
                    }
                }
            }
