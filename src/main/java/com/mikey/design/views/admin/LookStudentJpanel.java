...
public class LookStudentJpanel extends JPanel {
    ...
    public void getData(){
        ...
        //进行分页、每页显示20行信息
        pageData = studentService.getAllTeacherByPage(currentPage,pageSize);
        ...
        nextPage.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (pageData.getPageNum()==pageData.getPages()){
                    JOptionPane.showMessageDialog(showTipMessageLocationJpanel,"已经到达末页","系统提示",JOptionPane.INFORMATION_MESSAGE);
                    return;
                }else {
                    currentPage++;//设置为下一页
                    getData();
